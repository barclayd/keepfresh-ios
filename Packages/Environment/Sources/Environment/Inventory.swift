        ...
        icon: String)
    {
        ...
        Task.detached { [weak self] in
            do {
                ...
                if let categorySuggestions = categorySuggestions {
                    await SuggestionsCache.shared.saveSuggestions(categoryId: catgeory.id, categorySuggestions: categorySuggestions)
                }
            } catch {
