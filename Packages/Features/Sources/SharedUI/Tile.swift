    ...
    private func handleAction() {
        ...
        case .addItem:
            router.navigateTo(.addProduct(product: ProductSearchResultItemResponse(
                id: recentlyConsumedInventoryItem.product.id,
                name: recentlyConsumedInventoryItem.product.name,
                brand: recentlyConsumedInventoryItem.product.brand,
                category: ProductSearchItemCategory(
                    id: recentlyConsumedInventoryItem.product.category.id,
                    name: recentlyConsumedInventoryItem.product.category.name,
                    path: recentlyConsumedInventoryItem.product.category.pathDisplay,
                    recommendedStorageLocation: recentlyConsumedInventoryItem.storageLocation),
                amount: recentlyConsumedInventoryItem.product.amount,
                unit: recentlyConsumedInventoryItem.product.unit,
                icon: recentlyConsumedInventoryItem.product.category.icon)))
        }
    }
    ...
    public var body: some View {
        Button(action: handleAction) {
            VStack(alignment: .leading) {
                Text(recentlyConsumedInventoryItem.product.name)
                ...
                HStack {
                    ...
                    VStack(alignment: .trailing) {
                        ...
                        GenmojiView(
                            ...
                            fontSize: 56,
                            tint: recentlyConsumedInventoryItem.product.brand.color)
