...
public struct MoveInventoryItemSheet: View {
    ...
    public init(inventoryItem: InventoryItem, storageLocation: StorageLocation, onMove: @escaping (_ storageLocation: StorageLocation, _ expiryDate: Date) -> Void) {
    ...
    public var body: some View {
        VStack(spacing: 20) {
            ...
            InventoryCategory(type: .readOnlyStorage(location: storageLocation, isRecommended: true), storageLocation: storageLocation, forceExpanded: false, customColor: storageLocation == .freezer ? (.white200, .blue800) : nil)
