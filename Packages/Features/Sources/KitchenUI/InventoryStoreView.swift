  ...
  func sort(items: [InventoryItem]) -> [InventoryItem] {
    ...
    case .dateAdded(let direction):
      return items.sorted { lhs, rhs in
        switch direction {
        case .forward: return lhs.createdAt > rhs.createdAt
        case .backward: return lhs.createdAt < rhs.createdAt
        }
      }
    case .alphabetical(let direction):
      return items.sorted { lhs, rhs in
    ...
    case .expiryDate(let direction):
      return items.sorted { lhs, rhs in
        switch direction {
        case .forward: return lhs.expiryDate < rhs.expiryDate
        case .backward: return lhs.expiryDate > rhs.expiryDate
        }
      }
    }
  }
